...
#    type = string
#    default = "https://10.26.1.10:8006/api2/json"
#}
...
#    type = string
#    default = "cd0549ea-01e5-42db-8f6f-1212b961f8d9"
#    sensitive = true
#}
...
source "proxmox" "ubuntu-server" {
    ...
    proxmox_url = "https://10.26.1.10:8006/api2/json"
    username = "root@pam!packer"
    token = "cd0549ea-01e5-42db-8f6f-1212b961f8d9"
    ...
    ssh_private_key_file = "C:/users/michael/OneDrive/ssh_keys/ubuntuserver"
